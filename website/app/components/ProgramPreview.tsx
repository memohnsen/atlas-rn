...
export default function ProgramPreview({
  ...
  const dayOptions =
    availableDays ?? Array.from({ length: 7 }, (_, index) => index + 1);
  ...
  const expandListValues = (value: string, count: number) => {
    ...
    return [
      ...values,
      ...Array.from({ length: count - values.length }, () => last),
    ];
  };
  ...
  const handleAddSet = (
    ...
    const nextCount =
      getSetCount(currentSets, currentIntensity, currentReps) + 1;
    onOverrideChange(
      dayNumber,
      exerciseId,
      "sets",
  ...
  const handleRemoveSet = (
    ...
    const currentCount = getSetCount(
      currentSets,
      currentIntensity,
      currentReps,
    );
  ...
  const commitEdit = (
    ...
    const nextValue =
      field === "intensity" ? formatIntensity(editingValue) : editingValue;
    if (field === "name") {
          ...
          >
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              {dayOptions.map((dayNumber) => {
                const checked =
                  selectedDayNumbers?.includes(dayNumber) ?? false;
                return (
                  <label
                    key={dayNumber}
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <select
                        value={day.dayLabel ?? ""}
                        onChange={(event) =>
                          onDayLabelChange?.(day.dayNumber, event.target.value)
                        }
                        ...
                        style={{
                          ...
                          border: "1px solid #334155",
                          fontSize: "13px",
                          backgroundColor: onDayLabelChange
                            ? "#0f1419"
                            : "#1e293b",
                          color: "#e2e8f0",
                        }}
                    ...
                    >
                      ...
                      <tbody>
                        {day.exercises.flatMap((exercise, index) => {
                          ...
                          const intensityValues = expandListValues(
                            exercise.intensity || "",
                            setCount,
                          );
                          const repsValues = expandListValues(
                            exercise.reps || "",
                            setCount,
                          );
                          const total = getExerciseTotalReps(
                            exercise.reps || "",
                            setCount,
                          );
                          ...
                          return Array.from(
                            ...
                            (_, setIndex) => {
                              ...
                              return (
                                <tr
                                  key={`${exercise.id}-${index}-set-${setIndex}`}
                                >
                                  {isFirstRow && (
                                    <td
                                      rowSpan={setCount}
                                                ...
                                                {exerciseSuggestions.map(
                                                  (exerciseOption) => (
                                                    ...
                                                    >
                                                      ...
                                                      {(exerciseOption.primary ||
                                                        exerciseOption.secondary) && (
                                                        <span
                                                          style={{
                                                            fontSize: "11px",
                                                            color: "#64748b",
                                        ...
                                        >
                                          ...
                                          <button
                                            ...
                                            style={{
                                              ...
                                              backgroundColor: onDeleteExercise
                                                ? "#7f1d1d"
                                                : "#1e293b",
                                              color: onDeleteExercise
                                                ? "#fca5a5"
                                                : "#64748b",
                                              cursor: onDeleteExercise
                                                ? "pointer"
                                                : "not-allowed",
                                              fontSize: "12px",
                                              fontWeight: 600,
                                  ...
                                  >
                                    {onOverrideChange ? (
                                      <input
                                        ...
                                        onBlur={(event) => {
                                          const formatted = formatIntensity(
                                            event.target.value,
                                          );
                                          if (
                                        ...
                                        >
                                          ...
                                          <select
                                            ...
                                            style={{
                                              ...
                                              border: "1px solid #d1d5db",
                                              fontSize: "13px",
                                              backgroundColor: onOverrideChange
                                                ? "#fff"
                                                : "#f8fafc",
                                            }}
                                          >
            ...
            >
              ...
              <div style={{ overflowX: "auto" }}>
                ...
                >
                  <thead>
                    <tr
                      style={{ backgroundColor: "#0f1419", textAlign: "left" }}
                    >
                      <th
                        style={{
                          padding: "10px 12px",
                  ...
                  <tbody>
                    {(
                      ["snatch", "clean", "jerk", "squat", "pull"] as const
                    ).map((category) => {
                      const totalForWeek = parseCount(
                        getWeekTotal(week.weekNumber),
                      );
                      ...
                      week.days.forEach((day) => {
                        day.exercises.forEach((exercise) => {
                          ...
                          const exerciseTotal = getExerciseTotalReps(
                            exercise.reps || "",
                            setCount,
                          );
                      ...
                      const targetValue =
                        target === null ? null : parseCount(target);
                      const percentDiff =
                        actualValue !== null &&
                        targetValue !== null &&
                        targetValue !== 0
                          ? (Math.abs(actualValue - targetValue) /
                              targetValue) *
                            100
                          : null;
                      const actualColor =
